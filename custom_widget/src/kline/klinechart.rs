use crate::kline::kblock::{Kblock, KLineData};
...
impl<'a> KLineChart<'a> {
    pub fn new(datasets: Vec<Dataset<'a>>) -> KLineChart<'a> {
        KLineChart {
            block: None,
            x_axis: Axis::default(),
            y_axis: Axis::default(),
    ...
    pub fn block(mut self, block: Block<'a>) -> KLineChart<'a> {
        self.block = Some(block);
        self
    }

    pub fn style(mut self, style: Style) -> KLineChart<'a> {
        self.style = style;
        self
    }

    pub fn x_axis(mut self, axis: Axis<'a>) -> KLineChart<'a> {
        self.x_axis = axis;
        self
    }

    pub fn y_axis(mut self, axis: Axis<'a>) -> KLineChart<'a> {
        self.y_axis = axis;
        self
    }
    ...
    /// ```
    pub fn hidden_legend_constraints(mut self, constraints: (Constraint, Constraint)) -> KLineChart<'a> {
...
impl<'a> Widget for KLineChart<'a> {
